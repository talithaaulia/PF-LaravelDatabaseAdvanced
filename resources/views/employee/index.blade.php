...
{{-- menerapkan konsep inherintance dengan Blade Directive @extends() file layout utama (/layouts/app.blade.php),
    implementasi dynamic content dengan mendefinisikan Blade Directive @section() dan memanggilkan file yang berisi kode program
    untuk actions section dengan Blade Directive @include(). --}}
